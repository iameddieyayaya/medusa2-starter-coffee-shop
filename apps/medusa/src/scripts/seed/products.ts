...
export const seedProducts = ({
  ...
  shipping_profile_id: string;
    ...
    {
      title: 'Custom Mug - Personalized Coffee Mug',
      description:
        'Create your perfect coffee experience with our customizable ceramic mug. Add your own personal message or design to make this mug truly yours. Perfect for gifts or personal use, this high-quality mug will be your favorite coffee companion.',
      handle: 'custom-mug-personalized',
      status: ProductStatus.PUBLISHED,
      category_ids: categories.filter(({ name }) => name === 'Accessories').map(({ id }) => id),
      tag_ids: tags.filter((t) => ['Customizable'].includes(t.value)).map((t) => t.id),
      thumbnail: '../../../public/assets/images/coffee-mug.jpg',
      shipping_profile_id,
      metadata: {
        customizable: true,
        maxMessageLength: 40,
      ...
      images: [
        {
          url: '../../../public/assets/images/coffee-mug.jpg',
        },
      ],
      options: [
        {
